			...
			<div class="panel-body">
				...
				<form class="form-horizontal" role="form" method="POST" action="{{ route('employee.update', ['id' => $employee->id]) }}" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select class="form-control" name="cities_id">
								...
								<option {{$employee->cities_id == $city->id ? 'selected' : ''}} value="{{$city->id}}">{{$city->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select class="form-control" name="states_id">
								...
								<option {{$employee->states_id == $state->id ? 'selected' : ''}} value="{{$state->id}}">{{$state->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select class="form-control" name="countries_id">
								...
								<option {{$employee->countries_id == $country->id ? 'selected' : ''}} value="{{$country->id}}">{{$country->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
					...
					<div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
						<label for="zip" class="col-md-2 control-label">Age</label>
					...
					<div class="form-group">
						<label class="col-md-2 control-label">Hired Date</label>
						<div class="col-md-6">
							<div class="input-group date">
								<div class="input-group-addon">
									<i class="fa fa-calendar"></i>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select class="form-control" name="departments_id">
								...
								<option {{$employee->departments_id == $department->id ? 'selected' : ''}} value="{{$department->id}}">{{$department->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select class="form-control" name="divisions_id">
								...
								<option {{$employee->divisions_id == $division->id ? 'selected' : ''}} value="{{$division->id}}">{{$division->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						<label for="avatar" class="col-md-2 control-label" >Picture</label>
						<div class="col-md-6">
							<img src="{{ asset('storage/' .$employee->picture) }}" width="50px" height="50px"/>
